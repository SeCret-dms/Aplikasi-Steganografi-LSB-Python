...
class Gui:
    def __init__(self):
        ...
        self.root = Tk()
        self.root.title("Steganografi Menggunakan LSB")
        ...
        # encode tab
        Label(self.encode_frame, text="Masukan Pesan:").grid(row=0, column=0)
        self.msg = Entry(self.encode_frame, width=35)
        self.msg.grid(row=1, column=0)
        Label(self.encode_frame, text="Pilih Bit:").grid(row=2, column=0)
        ...
        self.browse_button = Button(self.encode_frame, text="Upload Gambar", command=self.read_image)
        self.store_location_button = Button(self.encode_frame, text="Simpan Lokasi Gambar",
        ...
        # decode tab
        self.decode_browse_button = Button(self.decode_frame, text="Upload Gambar", command=self.read_image)
        ...
        Label(self.decode_frame, text="Pilih Bit").grid(row=1, column=0)
    ...
    def encode_img(self, text, save_path):
        if self.image is None:
            ...
            logging.info("Pesan telah di encode!")
